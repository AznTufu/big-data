...
def silver_transformation_flow(clients_file: str = "clients.csv", purchases_file: str = "purchases.csv") -> Dict:
    """
    ...
    df_clients_raw = load_data_from_bronze(clients_file)
    ...
    clients_silver = save_to_silver(df_clients_clean, base_name)
    ...
    df_purchases_raw = load_data_from_bronze(purchases_file)
    ...
    purchases_silver = save_to_silver(df_purchases_clean, base_name)
